...
async function main() {
  ...
  const jewelry1 = await prisma.jewelry.create({
    data: {
      ownerId: seller.id,
      title: 'Collier Marocain Or 18K',
      description: 'Magnifique collier traditionnel marocain en or 18K, travail artisanal authentique.',
      images: ['/uploads/jewelry/necklace1.jpg'],
      type: 'NECKLACE',
      weight: 45.5,
      purity: 'K18',
    ...
    data: [
      {
        ...
        images: ['/uploads/jewelry/bracelet1.jpg'],
        type: 'BRACELET',
        weight: 28.3,
        purity: 'K22',
      ...
      },
      {
        ...
        images: ['/uploads/jewelry/earrings1.jpg'],
        type: 'EARRINGS',
        weight: 12.5,
        purity: 'K18',
      ...
      },
      {
        ...
        images: ['/uploads/jewelry/ring1.jpg'],
        type: 'RING',
        weight: 8.2,
        purity: 'K24',
      ...
      },
      {
        ...
        images: ['/uploads/jewelry/chain1.jpg'],
        type: 'CHAIN',
        weight: 35.0,
        purity: 'K22',
      ...
      },
      {
        ...
        images: ['/uploads/jewelry/pendant1.jpg'],
        type: 'PENDANT',
        weight: 15.8,
        purity: 'K18',
  ...
  await prisma.estimation.create({
    data: {
      userId: buyer.id,
      images: ['/uploads/estimations/est1.jpg'],
      weight: 25.5,
      purity: 'K18',
